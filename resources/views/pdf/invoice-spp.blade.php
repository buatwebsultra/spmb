<div class="border p-3 bg-white" style="width: 210mm; background-color: white">
    ...
    <div class="row">
        <div class="col">
            <dl class="row">
                ...
                <dt class="col-8 mb-0">Rp. {{$invoice['biaya_spp']}},-</dt>
                ...
                <dd class="col-12 mb-0">
                    <dl class="row ms-2">
                        ...
                        <dt class="col-sm-4 mb-0  text-end border-top"><strong>Rp. {{number_format(($setting['biaya_spp']+$setting['biaya_pendidikan']+$setting['biaya_almamater']+$setting['biaya_lain']) , 0, ',', '.');}}</strong></dt>
                      </dl>
                </dd>
            </dl>
        </div>
        <div class="col">
            <dl class="row">
                ...
                <dt class="col-10 mb-0">#{{$invoice['terbilang_spp']}}#</dt>
