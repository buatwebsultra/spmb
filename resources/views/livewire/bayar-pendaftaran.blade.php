                ...
                <table class="table table-sm table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$val->jurusan}}</td>
                            <td class="text-end">{{number_format($val->jumlah, 0, ',', '.')}}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Input Pembayaran Pendaftaran @if ($idp) <strong>{{$no_daftar}}</strong> @endif </h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <dl class="row my-4">
                                ...
                                <dd class="col-sm-3 mb-0">Tanggal Daftar</dd>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            @else
                            <p>Nomor Pendaftaran: <strong class="text-danger">{{$no_daftar}}</strong> tidak ditemukan</p>
                            @endif
                        </div>
                    </div>
                    @endif
