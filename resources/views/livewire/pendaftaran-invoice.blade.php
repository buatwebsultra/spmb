<div class="container container-fluid" style="overflow-x: auto">
    <div class="d-print-grid border p-3 shadow position-relative" style="width: 210mm;"> 
        <img src="{{$data['bgdaftar']}}" class="position-absolute top-50 start-50 translate-middle" style="width: 70%; opacity: 0.15; pointer-events: none; z-index: 0;" alt="watermark">
        ...
        <div class="row">
            ...
            <div class="col">
                <dl class="row">
                    ...
                    <dd class="col-4 mb-0">Pil. 1 Jurusan </dd>
